...
["#{count} Neutral"] = false;
["#{count} No"] = false;
["#{count} Si, elección alternativa"] = false;
["#{count} Si, primera elección"] = false;
["#{count} cancelado"] = false;
["#{count} finalizado"] = false;
["#{count} en discusión"] = false;
["#{count} en verificación"] = false;
["#{count} en votación"] = false;
["#{count} temas encontrados"] = false;
["#{count} miembros encontrados"] = false;
["#{count} más areas en esta unidad"] = false;
["#{count} nuevos"] = false;
["#{count} tienen una área de delegación"] = false;
...
["[event mail]    Policy: #{policy}"] = "    Método: #{policy}";
...
["ayer a las #{time}"] = false;
["tu estás interesado"] = false;
["tu estás suscripto"] = false;
["tienes #{count} delegaciones entrantes"] = false;
